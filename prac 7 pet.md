...
4. Identify their limitations and possible privacy risks.
...
| **Tor**    | Routes traffic through multiple relays to provide anonymity.                         | Stronger anonymity and IP-address protection.                             | Can be slower; anonymity can be weakened by unsafe browsing or incorrect configuration.                                     |
| **Signal** | Protects message and call contents using end-to-end encryption.                      | Strong protection for private communications.                             | Mainly protects communications within the application; it does not make the entire device or internet connection anonymous. |

### Effectiveness Evaluation
| Technology | Primary Privacy Purpose | Effectiveness                                            |
| ---------- | ----------------------- | -------------------------------------------------------- |
| VPN        | Network privacy         | High for protecting traffic from local network observers |
| Tor        | Online anonymity        | High for anonymity when used correctly                   |
| Signal     | Private communication   | High for protecting message/call contents                |
